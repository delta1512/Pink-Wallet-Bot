...
class User:
    ...
    def next_net_tx(self):
        return self.active_tx[1]+1.5*p.BLK_TIME*p.tx_timeout


    def next_fct(self):
        return self.last_faucet+3600*p.FCT_REQ_LIM
    ...
    def can_transact(self, amount, fee, net_tx=False):
        ...
        if fee != 0 and amount < (fee + p.MIN_TX): return docs.more_than_fee_and_min;
